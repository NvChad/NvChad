...
If you have any existing NeoVim config, move it with `mv ~/.config/nvim ~/.config/Nvim.backup`

To install NvChad, run: 
```
...
*Note: you may wish to install language servers with **:LspInstall < lang >**, see the docs for more info*
