...
M.comment = {
    ...
    n = {
        ["<C-_>"] = { function() require("Comment.api").toggle_current_linewise() end, "蘒  toggle comment" },
    },
...
M.gitsigns = {
    n = {
        ...
        ["<leader>hD"] = { "<cmd> lua require'gitsigns'.diffthis('~')<CR>", "diff this2"},
        ["<leader>td"] = { "<cmd> Gitsigns toggle_deleted<CR>", "toggle detected"},
    },
    o = {
        ["ih"] = {"<cmd> Gitsigns select_hunk<CR>", "select hunk1"}
    },
    x = {
        ["ih"] = {"<cmd> Gitsigns select_hunk<CR>", "select hunk2"}
    }
}
...
M.lspconfig = {
   n = {
      ...
      ["]d"]         = { function() vim.dagnostic.goto_next() end, "   goto_next" },
